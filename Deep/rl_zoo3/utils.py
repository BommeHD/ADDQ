...
# from rl_zoo3.custom_algos import TQCWSRFD
...
ALGOS: Dict[str, Type[BaseAlgorithm]] = {
    ...
    # custom algorithms
    "double_qrdqn": DoubleQRDQN,
    "clip_qrdqn": ClipQRDQN,
    "c51": C51,
    "double_c51": DoubleC51,
    "clip_c51": ClipC51,
    "double_qrsac": Double_QRSAC,
    "clip_qrsac": Clip_QRSAC,
    "adqrdqn": ADQRDQN,
    "adc51": ADC51,
    "qrsac": QRSAC,
    "adqrsac": ADQRSAC,
