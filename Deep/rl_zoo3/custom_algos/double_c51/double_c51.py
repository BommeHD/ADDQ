...
from rl_zoo3.custom_algos.double_c51.policies import CnnPolicy, MlpPolicy, MultiInputPolicy, C51Policy, CategoricalNetwork

SelfDoubleC51 = TypeVar("SelfDoubleC51", bound="DoubleC51")


class DoubleC51(OffPolicyAlgorithm):
    """
    ...
    def train(self, gradient_steps: int, batch_size: int = 100) -> None:
        ...
        for i in range(gradient_steps):
            ...
            with th.no_grad():
                ...
                # double logic
                next_probs = next_probs[th.arange(batch_size), 1 - random_indices]
