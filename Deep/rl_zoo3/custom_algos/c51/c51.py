...
from rl_zoo3.custom_algos.c51.policies import CnnPolicy, MlpPolicy, MultiInputPolicy, C51Policy, CategoricalNetwork
...
class C51(OffPolicyAlgorithm):
    ...
    def train(self, gradient_steps: int, batch_size: int = 100) -> None:
        ...
        for i in range(gradient_steps):
            ...
            selected_logits = current_logits[th.arange(batch_size), replay_data.actions.squeeze()]
