...
from rl_zoo3.custom_algos.clip_c51.policies import CnnPolicy, MlpPolicy, MultiInputPolicy, C51Policy, CategoricalNetwork

SelfClipC51 = TypeVar("SelfClipC51", bound="ClipC51")


class ClipC51(OffPolicyAlgorithm):
    """
    ...
    def __init__(
        ...
        self.median_idx = (self.n_atoms * self.categorical_net.n_critics - 1) // 2  # account for zero-based indexing
    ...
    def train(self, gradient_steps: int, batch_size: int = 100) -> None:
        ...
        for i in range(gradient_steps):
            ...
            with th.no_grad():
                ...
                # clip logic
                min_indices = (next_probs * self.support).sum(dim=-1).argmin(dim=-1)
                next_probs = next_probs[th.arange(batch_size), min_indices]
