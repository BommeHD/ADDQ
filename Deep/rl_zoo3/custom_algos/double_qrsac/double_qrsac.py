...
from rl_zoo3.custom_algos.double_qrsac.policies import Actor, CnnPolicy, Critic, MlpPolicy, MultiInputPolicy, TQCPolicy

SelfDouble_QRSAC = TypeVar("SelfDouble_QRSAC", bound="Double_QRSAC")


class Double_QRSAC(OffPolicyAlgorithm):
    """
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            with th.no_grad():
                ...
                # td error with double logic + entropy term
    ...
    def learn(
        self: SelfDouble_QRSAC,
        total_timesteps: int,
        callback: MaybeCallback = None,
        log_interval: int = 4,
        tb_log_name: str = "Double_QRSAC",
