...
from rl_zoo3.custom_algos.qrsac.policies import Actor, CnnPolicy, Critic, MlpPolicy, MultiInputPolicy, TQCPolicy

SelfQRSAC = TypeVar("SelfQRSAC", bound="QRSAC")


class QRSAC(OffPolicyAlgorithm):
    """
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            # Since n_critics is set to one, the indices are always zero
            zero_indices = th.randint(low=0, high=self.critic.n_critics, size=(batch_size,))
            ...
            with th.no_grad():
                ...
                # td error with regular target indices + entropy term
                target_quantiles = next_quantiles[
                    th.arange(batch_size), zero_indices
            ...
            selected_quantiles = current_quantiles[th.arange(batch_size), zero_indices]
