...
class HParamCallback(BaseCallback):
    ...
    def _on_training_start(self) -> None:
        hparam_dict = {
            ...
            "beta_explore": self.model.policy.beta_expl,
            "n_critics": self.model.policy.n_critics,
        }
        ...
        self.logger.record("static/beta", self.model.beta)
        self.logger.record("static/beta_explore", self.model.policy.beta_expl)
        self.logger.record("static/n_critics", self.model.policy.n_critics)
