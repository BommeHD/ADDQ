...
def plot_from_file_one_fig():  # noqa: C901
    ...
    ax.legend(handles, labels, loc="best", fontsize=args.fontsize)
    # ax.legend(handles, labels, loc="upper center", ncol=3, bbox_to_anchor=(0.5, 1.17), fontsize=args.fontsize)
