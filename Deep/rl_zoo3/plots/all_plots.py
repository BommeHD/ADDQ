...
def all_plots():  # noqa: C901
    ...
    parser.add_argument("-max", "--max-timesteps", help="Max number of timesteps to display", type=int, default=int(20e6))
    ...
    parser.add_argument(
        "-print", "--print-n-trials", action="store_true", default=True, help="Print the number of trial for each result"
    )
        ...
        for algo in args.algos:
            for folder_idx, exp_folder in enumerate(args.exp_folders):
                ...
                for _, dir_ in enumerate(dirs):
                    ...
                    if log["timesteps"][-1] < args.min_timesteps:
                        continue
                ...
                if len(merged_results) > 0:
                    ...
                    if args.print_n_trials:
                        ...
                        for i in kept_runs:
                            with open(os.path.join(runs[i], env, "args.yml"), "r") as file:
